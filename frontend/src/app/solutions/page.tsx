    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {caseStudies.map((cs) => {
          ...
          return (
            <Link
              ...
              className="scada-panel overflow-hidden glow-border group"
            >
              ...
              <div className="p-6">
                {cs.industry && (
                  <div className="text-xs font-mono text-accent-green mb-2 uppercase">
                    {cs.industry}
                  </div>
                )}
                ...
                {cs.problem && (
                  <p className="text-sm text-scada-muted mb-4 line-clamp-2">{cs.problem}</p>
                )}
      ...
      {!caseStudies.length && (
        <div className="scada-panel p-12 text-center">
          <p className="text-scada-muted">Все още няма публикувани case studies.</p>
        </div>
      )}
    </div>
  );
